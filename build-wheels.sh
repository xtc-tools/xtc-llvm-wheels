...
ENV_VARS=(
    ...
    ${CIBW_REPAIR_WHEEL_COMMAND_LINUX:+CIBW_REPAIR_WHEEL_COMMAND_LINUX="$CIBW_REPAIR_WHEEL_COMMAND_LINUX"}
    ${CIBW_REPAIR_WHEEL_COMMAND_MACOS:+CIBW_REPAIR_WHEEL_COMMAND_MACOS="$CIBW_REPAIR_WHEEL_COMMAND_MACOS"}
)
